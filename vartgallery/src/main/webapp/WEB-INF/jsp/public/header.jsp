    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white vag-headnav-container">
        ...
        <div class="collapse navbar-collapse vag-navbar-collapse-center" id="headNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="btn vag-btn-tan" href="#"><i class="bi bi-cart"></i> Cart</a></li>
                <li class="nav-item"><a class="btn vag-btn-tan" href="#"><i class="bi bi-person-circle"></i> Sign in</a></li>
            </ul>
        </div>
    </nav>
</header>